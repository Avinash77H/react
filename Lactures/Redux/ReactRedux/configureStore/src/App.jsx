...
import './App.css'
import { buy_pen } from './redux/Actions'
import { buy_pencil } from './redux/Actions'


function App() {
  const pen = useSelector((state)=>state.penReducer.pen)
  const pencil = useSelector((state)=>state.pencilReducer.pencil)
