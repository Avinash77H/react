  ...
  return (
    <div classNameName='border border-red-500'>
        ...
        <div className="mt-4 flex justify-between items-center gap-8 flex-col md:flex-row">
            <div className="flex">
                <input type="text" placeholder="Type a name..." className="border-2 border-gray-300 rounded-s-md "></input>
     ...
     <div className="table-container overflow-x-auto">
        <table className="border-collapse border border-black mt-8 w-full">
            <tr className="tableHeading text-nowrap">
                <th className="border border-black  chameli"><input type="checkbox" className="input-checkbox"></input></th>
            ...
            <tr className="text-nowrap">
                <td className="border border-black text-center"><input type="checkbox"></input></td>
                <td className="border border-black text-center">Pillow</td>
                <td className="border border-black text-center">Sleeping well is important.</td>
            ...
            <tr className="text-nowrap">
                ...
                <td className="border border-black text-center">You need this one if you love music.</td>
            ...
            <tr className="text-nowrap">
                ...
                <td className="border border-black text-center">Very useful if you love your computer.</td>
            ...
            <tr className="text-nowrap">
                ...
                <td className="border border-black text-center">It will help you maintain cleanliness. </td>
            ...
            <tr className="text-nowrap">
                ...
                <td className="border border-black text-center"> It will make you read better.</td>
        ...
        <div className="mt-4 flex justify-between flex-wrap gap-4">
                ...
                <div>
                    <nav className="isolate inline-flex -space-x-px rounded-md shadow-sm" aria-label="Pagination">
                        ...
                        <a href="#" aria-current="page"
                            className="relative z-10 inline-flex items-center bg-blue-500 px-4 py-2 text-sm font-semibold text-white focus:z-20 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500">1</a>
                        <a href="#"
                ...
                <div className="flex">
                    <input type="text" placeholder="  Type page Number..." className="border-2 border-gray-300 rounded-s-md "></input>
